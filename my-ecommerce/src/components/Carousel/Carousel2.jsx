...
function Carousel2() {
  const caption = (
    <div className="absolute top-2/4 left-1/3 transform -translate-x-1/2 -translate-y-1/2 text-white flex flex-col gap-4 max-w-screen-2xl sm:mx-auto sm:top-1/4 sm:left-2/3 sm:pr-36 sm:gap-3 sm:mt-28 sm:text-center sm:w-[100%]">
      <h5 className="font-bold tracking-wider mb-4">SUMMER 2020</h5>
      <h1 className="font-bold text-7xl tracking-wider mb-4 sm:text-4xl">
      ...
      <div className="flex flex-row gap-5 sm:flex-col">
        ...
        <button className="bg-[#2DC071] text-white font-bold text-s py-3 rounded leading-8 w-[180px] sm:scale-75 sm:mx-auto">
          ADD TO CART
        </button>
      </div>
    </div>
  ...
  return (
    <>
      <div className="relative bg-priceGreen">
        <Carousel
          className="max-w-[1800px] max-h-[1000px] bg-[#23856D] relative overflow-hidden mx-auto sm:h-[1230px]"
