  ...
  return (
    <div className="font-['Montserrat']">
      <div>
        ...
        <div className="flex gap-[50px] flex-wrap items-center justify-center pb-[80px] max-w-[90rem] mx-auto mt-12">
          {productlist.map((product, index) => (
            <div key={index}>
              <img src={product.img} />

              <div className="flex flex-col items-center py-[30px] gap-[10px]">
                <h5 className="text-[16px] font-semibold ">{product.title}</h5>
